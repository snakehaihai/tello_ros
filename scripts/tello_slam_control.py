...
class TelloSlamControler(object):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.pose_topic_name = '/AirSLAM/frame_pose'+str(self.id)
    ...
    def slam_callback(self, slam_msg):
        ...
        # 2. Obtain quaternion poses and convert them to Euler angles
        ...
        # Convert Euler angles to Point format (roll, pitch, yaw)
        ...
        # 3. Attitude smoothing processing
